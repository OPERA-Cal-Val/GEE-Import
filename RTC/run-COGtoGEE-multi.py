...
def uploadAsset(key):
    ...
    #folderPath = 'products/2023-05-04_globalrun_2021-04-11_to_2021-04-22'
    folderPath = 'collections/Africa_Jan2024'
    #targetCollectionPath = 'projects/opera-one/assets/RTC/VH-2023-05-09-First1000'
    targetCollectionPath = 'projects/opera-one/assets/RTC/Africa_Jan2024'
...
if __name__ == '__main__':
    ...
    blobs = storage_client.list_blobs(bucket_name, prefix=folderPath+'/',max_results=999999)
    gcsKeys = []
    for blob in blobs:
